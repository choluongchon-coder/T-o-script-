-- =========================================================================
-- SCRIPT: HYDRADAT ULTIMATE (FIXED FALLING & COLOR SYNC)
-- =========================================================================
...
-------------------------------------------------------------------
-- 1. HÀM CẬP NHẬT TRẠNG THÁI MÀU (XANH/ĐỎ)
-------------------------------------------------------------------
...
-------------------------------------------------------------------
-- 2. LOGIC VÁN GẮN CHÂN (FIX TỰ RƠI)
-------------------------------------------------------------------
RunService.RenderStepped:Connect(function()
    ...
    if _G.PlatformEnabled and hrp then
        if not PlatformPart or not PlatformPart.Parent then
            ...
            PlatformPart.Anchored = false -- ĐỂ FALSE ĐỂ NÓ DÍNH CHÂN
            PlatformPart.CanCollide = true
            PlatformPart.Parent = char
            
            -- Gắn ván vào chân nhân vật bằng Weld
